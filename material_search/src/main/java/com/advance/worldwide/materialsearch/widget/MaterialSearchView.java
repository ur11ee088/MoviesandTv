package com.advance.worldwide.materialsearch.widget;
...
import com.advance.worldwide.materialsearch.R;
import com.advance.worldwide.materialsearch.SearchAdapter;
import com.advance.worldwide.materialsearch.utils.AnimationUtil;

import java.lang.reflect.Field;
import java.util.List;

/**
 * Custom View class to handle search view actions
 */
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private boolean onlySetText = false;
    ...
    private void onBackButtonPress() {
        if (!isShowAlways) {
            closeSearch();
        } else if (mSearchViewListener != null) {
            mSearchViewListener.onSearchBackPressed();
        }
    }
...
//        mSearchSrcTextView.setText(null);
    ...
    public void closeSearch() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            AnimationUtil.exitReveal(mSearchTopBar, animationListener);
        } else {
            mSearchLayout.setVisibility(GONE);
        }
        mIsSearchOpen = false;
    ...
    public void setShowAlways(boolean state) {
        isShowAlways = state;
